...
{{ image(src="img/pve_e1000e_hangups/souls_title.webp", alt="Image saying detected hardware unit hang in capital letters, stylized as a Dark Souls III caption.", position="center", style="background-color: white; width: 100%;") }}
...
{{ image(src="img/pve_e1000e_hangups/environment.svg", alt="Vacuum tube with powered on heater filaments", position="center", style="padding: 1em; background-color: white") }}
